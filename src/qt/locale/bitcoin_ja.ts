...
<context>
    ...
    <message>
        ...
        <translation>これらは支払いを受け取るためのAPIXCashアドレスです。トランザクションごとに新しい受け取り用アドレスを作成することが推奨されます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>暗号化処理を完了させるため %1 をいますぐ終了します。ウォレットの暗号化では、コンピュータに感染したマルウェアなどによるAPIXCashの盗難から完全に守ることはできないことにご注意ください。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>支払いを要求する (QRコードとapix:ではじまるURIを生成する)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>apix: URIまたは支払いリクエストを開く</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>%1はAPIXCashのブロックチェーンの複製をダウンロードし保存します。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>確認できない最近のトランザクションがあるかもしれません。これによりウォレットの残高は不正確なものである可能性があります。この情報はウォレットが一度APIXCashネットワークへの同期が完了すると正確なものとなります。詳細は下記を参照してください。</translation>
    </message>
    <message>
        ...
        <translation>まだ表示されていないトランザクションが影響するAPIXCashを使用しようとすると、ネットワークから認証がなされないでしょう。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>URI を解析できません! これは無効な APIXCash アドレスあるいは不正な形式の URI パラメーターによって引き起こされる場合があります。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ブロックの容量に比べてトランザクション流量が少ないうちは最小手数料のみの支払で十分です。しかしながらネットワークが処理しきれないほどapixトランザクションの需要がひとたび生まれてしまった場合には、永遠に検証がされないトランザクションになってしまう可能性があることに注意してください。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>送金する金額から手数料が差し引かれます。受取人は数量フィールドで指定した量よりも少ないAPIXCashを受け取ります。受取人が複数いる場合には、手数料は均等割されます。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>apix: URIに添付されていたメッセージです。これは参照用としてトランザクションとともに保存されます。注意：このメッセージはAPIXCashネットワークを通して送信されるわけではありません。</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
<context>
    ...
    <message>
        ...
        <translation>あなたの所有しているアドレスによりメッセージや合意書に署名をすることで、それらアドレスに対して送られたAPIXCashを受け取ることができることを証明できます。フィッシング攻撃により不正にあなたの識別情報を署名させられてしまうことを防ぐために、不明確なものやランダムなものに対して署名しないよう注意してください。合意することが可能な、よく詳細の記された文言にのみ署名するようにしてください。</translation>
    </message>
    <message>
